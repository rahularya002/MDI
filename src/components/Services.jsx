...
export default function Component() {
    return (
        <section id="Services" className="w-full py-12 bg-gradient-to-r from-blue-200 to-cyan-200">
            <div className="container px-4 md:px-6 mx-auto">
                <div className="grid gap-6 items-center">
                    <div className="flex flex-col justify-center space-y-8 text-center">
                        <div className="space-y-2">
                            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl bg-gradient-to-r from-fuchsia-600 to-pink-600 bg-clip-text text-transparent">
...
function FeatureCard({ icon, title, description }) {
    return (
        <div className="flex flex-col items-center space-y-2 p-4 rounded-lg bg-gray-900 bg-opacity-50">
